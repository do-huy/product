                ...
                <div class="row li-main-content">
                    <div class="col-lg-12">
                        <div class="li-blog-single-item pb-30 pt-25">
                            <h4 class="title-form-profile">Thêm mới địa chỉ</h4>
                            <form id="form-address" data-profile-store-address-route="{{ route('client.profile.store.address') }}">
                                @csrf
                                <div class="div-avatar-name-profile">
                                    ...
                                    <div class="div-name-profile">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control height-input-select" id="district_id" name="district_id">
                                            </select>
                                            <span class="text-danger" id="err-district_id"></span>
                                        </div>
                                        <div class="form-group">
                                            <label id="label-file" for="name">Quận huyện</label>
                                            <select id="ward_id" class="form-control height-input-select" name="ward_id">
                                            </select>
                                            <span class="text-danger" id="err-ward_id"></span>
                                        </div>
                                        <div class="form-group">
                                            <label id="label-file" for="name">Địa chỉ chi tiết</label>
                                            <textarea type="text" name="description" class="form-control height-input-textarea">{{ old('description') }}</textarea>
                                            <span class="text-danger" id="err-description"></span>
                                        </div>

                                        <div class="form-group">
                                            <input type="checkbox" name="is_default" class="check-default"> <span class="custom-default"> Đặt làm địa chỉ mặc định</span>
                                ...
                                <div class="btn-submit-profile">
                                    <div class="form-group">
                                        <button type="button" id="submit-store-address" class="btn-sene">Lưu thông tin</button>
                                    </div>
                                </div>
                            </form>
                        </div>
