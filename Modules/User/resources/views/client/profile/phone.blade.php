                ...
                <div class="row li-main-content">
                    <div class="col-lg-12">
                        <div class="li-blog-single-item pb-30 pt-25">
                            <h4 class="title-form-profile">Cập nhập số điện thoại</h4>
                            <form id="update-account" method="POST" enctype="multipart/form-data" data-update-profile-phone-route="{{ route('client.profile.phone.update') }}">
                                @csrf
                                <div class="div-avatar-name-profile">
                                    ...
                                    <div class="div-name-profile">
                                        ...
                                        <div class="form-group form-name">
                                            <label id="label-file" class="label-name" for="name">Số điện thoại *</label>
                                ...
                                <div class="btn-submit-profile">
                                    <div class="form-group">
                                        <button type="button" id="submit-update-profile-phone" class="btn-sene">Lưu thông tin</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
@section('js')
    <script src="{{ asset('client/js/profile/phone.js') }}"></script>
@endsection
